...
def get_preview_plugin(data_dict: Dict, return_first: bool = ...) -> Dict: ...
def get_view_plugin(view_type: str) -> Dict: ...
def get_view_plugins(view_types: Iterable[str]) -> List[Dict]: ...
def get_allowed_view_plugins(data_dict: Dict) -> List[Dict]: ...
