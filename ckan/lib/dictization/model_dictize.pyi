...
'''
def group_list_dictize(obj_list, context, sort_key=..., reverse=..., with_package_counts=..., include_groups=..., include_tags=..., include_extras=...):
    ...
...
def group_dictize(group, context, include_groups=..., include_tags=..., include_users=..., include_extras=..., packages_field=..., **kw):
    '''
...
def user_dictize(user, context, include_password_hash=..., include_plugin_extras=...):
    ...
