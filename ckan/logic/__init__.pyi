...
ErrorDict = Dict[str, List[Union[str, Dict]]]
...
def validate(
    schema_func: Callable, can_skip_validator: bool = ...
) -> Callable: ...
def side_effect_free(action: Callable) -> Callable: ...
def auth_sysadmins_check(action: Callable) -> Callable: ...
def auth_audit_exempt(action: Callable) -> Callable: ...
def auth_allow_anonymous_access(action: Callable) -> Callable: ...
def auth_disallow_anonymous_access(action: Callable) -> Callable: ...
def chained_auth_function(func: Callable) -> Callable: ...
