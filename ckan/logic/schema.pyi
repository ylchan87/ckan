...
def default_update_vocabulary_schema(
    ignore_missing, vocabulary_id_not_changed, vocabulary_name_validator
): ...
@validator_args
...
def default_follow_dataset_schema(
    not_missing, not_empty, unicode_safe, convert_package_name_or_id_to_id
): ...
@validator_args
def member_schema(
    not_missing,
...
def default_follow_group_schema(
    not_missing, not_empty, unicode_safe, convert_group_name_or_id_to_id
): ...
@validator_args
...
def default_dashboard_activity_list_schema(
    configured_default, natural_number_validator, limit_to_configured_maximum
): ...
@validator_args
...
def default_create_api_token_schema(
    not_empty, unicode_safe, ignore_missing, json_object, ignore_not_sysadmin
): ...
@validator_args
