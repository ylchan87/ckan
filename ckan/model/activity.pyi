...
class Activity(domain_object.DomainObject):
    def __init__(
        self, user_id, object_id, activity_type, data=...
    ) -> None: ...
    @classmethod
    def get(cls, id):
...
class ActivityDetail(domain_object.DomainObject):
    def __init__(
        self, activity_id, object_id, object_type, activity_type, data=...
    ) -> None: ...
    @classmethod
...
def package_activity_list(
    package_id, limit, offset, include_hidden_activity=...
):
...
def organization_activity_list(
    group_id, limit, offset, include_hidden_activity=...
):
